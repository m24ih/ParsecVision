  ...
  return (
    <div className="container">
      <div className="sidebar">
        <h2 style={{ color: "var(--highlight)", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "1.5rem", margin: "0 0 20px 0", whiteSpace: "nowrap" }}>
          <span>PARSEC VISION</span>
          <button 
        ...
        {analysisResult?.astrometry && (
          ...
          >
            ...
            {cosmicExplanation && (
              <div className="cosmic-explanation">
            ...
            {/* EXPORT BUTTON SADECE ANALİZ BİTİNCE ÇIKACAK */}
            {cosmicExplanation && (
              <button 
                onClick={exportToPDF} 
                disabled={isExporting}
                style={{ marginTop: "15px", borderColor: "#fff", color: "#fff" }}
              >
